...
package alternativa.engine3d.primitives {
	 ...
	 * A plane primitive.
	 */
	public class Plane1 extends Mesh {
		 ...
		 */
		public function Plane1(width:Number = 100, length:Number = 100, widthSegments:uint = 1, lengthSegments:uint = 1, twoSided:Boolean = true, reverse:Boolean = false, bottom:Material = null, top:Material = null) {
			...
			for (x = 0; x < wEdges; x++) {
				for (y = 0; y < lEdges; y++) {
					...
					vertices.writeFloat(y*segmentLength);
		...
		override public function clone():Object3D {
			var res:Plane1 = new Plane1(0, 0, 0, 0);
