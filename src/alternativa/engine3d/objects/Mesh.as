...
package alternativa.engine3d.objects {
	...
	public class Mesh extends Object3D {
		...
		public function set alpha(index:Number):void {
			 for each(var dsw:Surface in _surfaces)
			 {
				if (dsw.material is TextureMaterial) (dsw.material as TextureMaterial).alpha = index;
				if (dsw.material is VertexLightTextureMaterial) (dsw.material as VertexLightTextureMaterial).alpha = index;
				if (dsw.material is StandardMaterial) (dsw.material as StandardMaterial).alpha = index;
			 }
		}
		
		public function get alpha():Number {
			if (_surfaces[0].material is TextureMaterial) return (_surfaces[0].material as TextureMaterial).alpha;
			if (_surfaces[0].material is VertexLightTextureMaterial) return (_surfaces[0].material as VertexLightTextureMaterial).alpha;
			if (_surfaces[0].material is StandardMaterial) return (_surfaces[0].material as StandardMaterial).alpha;
			return 0;
		}
