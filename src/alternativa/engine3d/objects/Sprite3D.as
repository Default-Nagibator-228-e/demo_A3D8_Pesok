...
package alternativa.engine3d.objects {
	...
	public class Sprite3D extends Object3D {
		...
		public function set alpha(index:Number):void {
			if(surface.material is TextureMaterial) (surface.material as TextureMaterial).alpha = index;
		}
		
		public function get alpha():Number {
			if (surface.material is TextureMaterial) return (surface.material as TextureMaterial).alpha;
			return 0;
		}
