package utils.textureutils
{
   ...
   public class TextureConstructor
   {
      ...
      public function createTexture(textureData:TextureByteData, listener:ITextureConstructorListener,dsad:Boolean = false,s:String = "") : void
      {
         if(this.loader != null)
         {
      ...
      private function complete() : void
      {
         ...
         this.listener = null;
         listener.onTextureReady(this,swer,ssw);
      }
   }
}
